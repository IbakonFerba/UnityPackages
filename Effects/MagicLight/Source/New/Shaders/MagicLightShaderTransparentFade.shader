...
/*
* This Shader is basically a Standard Transparent Surface Shader with fade blending, but with the added effect that it is cut away inside the cylinder of the MagicLightsource or a specified stencil.
...
*/
Shader "Magic Light/Transparent Fade" {
	Properties {
	...
	SubShader {
		...
		#pragma surface surf Standard vertex:vert fullforwardshadows finalcolor:renderBorderAndSecondColor alpha:fade
