...
/*
* This Shader is basically a Standard Transparent Surface Shader with fade blending, but with the added effect that it is cut away inside the cylinder of the MagicLightsource.
