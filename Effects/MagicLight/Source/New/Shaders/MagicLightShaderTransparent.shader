...
/*
* This Shader is basically a Standard Transparent Surface Shader, but with the added effect that it is cut away inside the cylinder of the MagicLightsource or a specified stencil.
...
*/
Shader "Magic Light/Transparent" {
	Properties {
	...
	SubShader {
		...
		#pragma surface surf Standard vertex:vert fullforwardshadows finalcolor:renderBorderAndSecondColor alpha:premul
