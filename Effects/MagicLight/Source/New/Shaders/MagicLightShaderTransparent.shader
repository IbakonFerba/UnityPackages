...
/*
* This Shader is basically a Standard Transparent Surface Shader, but with the added effect that it is cut away inside the cylinder of the MagicLightsource.
