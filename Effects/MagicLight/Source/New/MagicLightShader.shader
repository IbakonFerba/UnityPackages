...
Shader "Magic Light/Standard" {
	...
	SubShader {
	    ...
	    CGPROGRAM
			...
			{
			    // clip everything inside magic light
				if(_UseMagicLight) 
				    clipOutsideLightCircle(i.worldPos.xyz, _MagicLightDir.xyz, _MagicLightPos.xyz, _MagicLightRad*_RadiusScaleFactor, _WobbleSpeed, _WobbleStrength, _Time, _Inverted);
