...
{
    /// <summary>
    /// <para>An extension of the TextMeshProUGUI Text that gets its text from the Language Manager and changes its text automatically whenever the language changes</para>
    ///
    /// v1.1 09/2018
    ...
    public class TextMeshProUGUILanguageText : TextMeshProUGUI
    {
        // ######################## PRIVATE VARS ######################## //
        ...
        {
            GameObject go = new GameObject("TextMeshPro LanguageText", typeof(RectTransform), typeof(LanguageTextConfig), typeof(TextMeshProUGUILanguageText));
            TextMeshProUGUILanguageText lt = go.GetComponent<TextMeshProUGUILanguageText>();
